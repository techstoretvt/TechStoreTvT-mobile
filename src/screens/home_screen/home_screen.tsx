                    ...
                    <View>
                        ...
                        <View style={styles.carousel_header_container}>
                            <View style={styles.carousel_header_content}>
                                <View
                                    style={styles.carousel_header_wrap_header}
                                >
                                    <HeaderHome />
                                </View>
                                <SliderImage
                        ...
                        <View style={styles.firstAdvertisement_container}>
                            ...
                            >
                                <View
                                    style={
                                        styles.firstAdvertisement_container_wrap_btn
                                    }
                                >
                                    <Text
                                        style={
                            ...
                            >
                                <View
                                    style={
                                        styles.firstAdvertisement_container_wrap_label
                                    }
                                >
                                    <Text
                                        style={[
                        ...
                        <View style={styles.secondAdvertisement_container}>
                            <View style={styles.secondAdvertisement_content}>
                                <Image
                                    ...
                                    style={
                                        styles.secondAdvertisement_content_image
                                    }
                                />
                                <Image
                                    source={{
                                ...
                                <View
                                    style={
                                        styles.secondAdvertisement_content_wrap_label
                                    }
                                >
                                    <View
                                        style={
                                            styles.secondAdvertisement_content_label
                                        }
                                    >
                                        <Text
                                            // eslint-disable-next-line react-native/no-inline-styles
                        ...
                        <View style={styles.promotionProduct_container}>
                            <View style={styles.promotionProduct_header}>
                                <View
                                    style={styles.promotionProduct_header_left}
                                >
                                    <CountDown
                                        until={60 * 60 * 24 * 7}
                                ...
                                >
                                    <Text
                                        style={
                                            styles.promotionProduct_header_right_text
                                        }
                                    >
                                        Xem tat ca
                                    </Text>
                            ...
                            >
                                <View
                                    style={
                                        styles.promotionProduct_listProduct_product
                                    }
                                >
                                    <ImageBackground
                                        source={{
                        ...
                        <View style={styles.finallyAdvertisement_container}>
                            <View style={styles.finallyAdvertisement_header}>
                                <View
                                    style={
                                        styles.finallyAdvertisement_header_item
                                    }
                                >
                                    <View
                                        style={
                            ...
                            <View
                                style={styles.finallyAdvertisement_wrapSlider}
                            >
                                <SliderImage
                                    listImages={listImages}
                                    height={120}
                        ...
                        <View style={styles.suggestion_container_header}>
                            <Text
                                style={styles.suggestion_container_header_title}
                            >
                                Gới ý hôm nay
                            </Text>
                        </View>
